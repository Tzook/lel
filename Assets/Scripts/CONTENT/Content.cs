...
public class DevSpellBase 
{
    ...
    public List<DevPerkMap> Perks = new List<DevPerkMap>();
    [Popup(/* AUTO_GENERATED_BUFFS_START */ "NO VALUE", "bleedChance", "crippleChance", "freezeChance", "hasteChance", "stunChance" /* AUTO_GENERATED_BUFFS_END */)]
