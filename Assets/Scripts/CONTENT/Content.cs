...
{
    [Popup(/* AUTO_GENERATED_LOOT_START */ "NO VALUE", "adventurerShirt", "apprenticeRobeBlack", "apprenticeRobeWhite", "archershat", "batWing", "bigFish", "blackclothshirt", "blackGloves", "blackJellyBean", "blackPants", "blackpeasentshirt", "blackShoes", "blueBerries", "blueJellyBean", "blueMushroomCap", "bluepeasentshirt", "brownpeasentshirt", "captianscoat", "carrotSack", "clothPants", "cosmoTunnelKey", "Fishing Rod", "gold", "greenGloves", "greenJellyBean", "greenPants", "greenpeasentshirt", "improvedshortbow", "leatherGloves", "leatherShoes", "leatherVest", "lightgambesson", "magicCarrotSeeds", "mailsabatons", "mailshoes", "metalbow", "nutVaultKey", "oldTurtleShell", "orangeclothshirt", "orangeJellyBean", "peasantHat", "pinkclothshirt", "pinkJellyBean", "plantFlower", "rabbitCostume", "rabbitEar", "rabbitFurVest", "rabbitLandEntrancePremission", "redBerries", "redGloves", "redJellyBean", "redpeasentshirt", "shortAxe", "shortBow", "shortClub", "shortDagger", "shortScimitar", "shortSword", "smallFish", "snailhat", "strapShoes", "strawHat", "swordOfElad", "tatteredblackpants", "tatteredbrownpants", "tatteredgreenpants", "tatteredwhitepants", "tomato", "turtleShell", "turtleShellOld", "turtleShellSpiked", "warbow", "whiteclothshirt", "whiteGloves", "whiteJellyBean", "yellowJellyBean", "yellowshoes" /* AUTO_GENERATED_LOOT_END */)]
