...
public class DevBuff
{
    ...
    public string DebuffSoundKey;

    public string DebuffPrefabKey;
}
...
{
    [Popup(/* AUTO_GENERATED_QUESTS_START */ "NO VALUE", "ABeanyRequest", "aidingTheCommunity", "ancientRabbitholes", "bigOnes", "bigOnesDivine", "bigOnesIce", "bigOnesMelting", "bigOnesScimitar", "blockingTheView", "breakIntoSpa", "bustNuts", "carrotSupply", "CleaningUp", "divinePlace", "examineLostSupplies", "FatAlbert", "findAlex", "findCosmo", "findCosmo2", "findCosmo3", "findKaren", "frostPractice", "FrostTest", "hairPotion", "helpAlex", "helpJaxTheDog", "helpJaxTheDog2", "helpMaya", "jacksVengeance", "jacksVengeance2", "jacksVengeance3", "joinShrine", "mayaSpikedTurtles", "OldFriends", "petRansom", "petRansom2", "picnicSupplies", "piratesAmbush", "practiceHealing", "rabbitRaids", "rangerPractice", "RangerPractice2", "RangerTest", "ruinedPainting", "sacrificeFrostGod", "summonAnAngel", "thisIsNecessary1", "thisIsNecessary2", "thisIsNecessary3", "turtleProblem", "TurtleQuizz", "turtleSoup", "untieNurtle" /* AUTO_GENERATED_QUESTS_END */)]
